...
def analysis_13_least_time_spent():
    ...
    # Top 5 lowest-count categories only
    res_bottom = res.sort_values(ascending=False).head(5)

    print("\nLEAST TIME SPENT SECTION (TOP 5)")
    print(res_bottom)

    save_bar(
        res_bottom,
        "Top 5 Sections Where Customers Spend the Least Time",
        "Number of Mentions",
        "Store Section",
